...
public:
    ...
    AirportCounter()
    {
        for (int i = 0; i < (int)TAirport::Last_; ++i) {
            TAirport airport = (TAirport)i;
            _data[i] = std::make_pair(airport, 0);
        }
    }
